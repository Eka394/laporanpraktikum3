                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ButtonStyle(
                        ...
                        foregroundColor: MaterialStateProperty.all<Color>(Color.fromRGBO(0, 171, 20, 1)),
                        side: MaterialStateProperty.all<BorderSide>(BorderSide(color: const Color.fromRGBO(0, 171, 20, 1), width: 1.5)),
                      ),
                      child: Text(
                        'Edit',
                        style: TextStyle(
