        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            bottom: TabBar(
              ...
              unselectedLabelColor: Colors.white.withOpacity(0.5), // Warna teks tab tidak aktif
              indicatorSize: TabBarIndicatorSize.tab, // Ukuran garis bawah sesuai dengan panjang tab
              ...
              Scaffold(
                body: GridView.count(
                  ...
                  children: [
                    ...
                    buildGridItem('', 'assets/owl.jpg'),
                    buildGridItem('', 'assets/owl.jpg', alignment: Alignment.topCenter),
                    buildGridItem('', 'assets/owl.jpg', alignment: Alignment.topCenter),
                  ],
                ),
              ),
